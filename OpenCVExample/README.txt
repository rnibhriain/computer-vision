...
This is a complete Visual Studio Project developed using Visual Studio 2019 and OpenCV 4.5.3 under Windows 10.  It should work on different versions with a little work.

1. You should install OpenCV v4.5.3 on your system in somewhere like C:\   It will automatically create an "opencv" folder in this location.
